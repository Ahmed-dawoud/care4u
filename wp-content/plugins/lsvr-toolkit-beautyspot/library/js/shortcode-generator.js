...
----------------------------------------------------------------------------- */
        ...
        var lsvr_sg_add_colorpicker = function( name, atts ){
            ...
            html += '><div class="lsvr-btn"><i class="fa fa-tint"></i></div></div>';
...
----------------------------------------------------------------------------- */
        ...
        var lsvr_sg_add_shortcode_form = function( pos, shortcode ){
            ...
            // INIT COLORPICKER
            pos.find( '.lsvr-sg-colorpicker .lsvr-btn' ).ColorPicker({
                onSubmit: function(hsb, hex, rgb, el) {
                    $(el).parent().find( '.lsvr-sg-att' ).val( hex );
                    $(el).ColorPickerHide();
                },
                onBeforeShow: function () {
                    //$(this).ColorPickerSetColor(this.value);
                    $(this).ColorPickerSetColor( $(this).parent().find( '.lsvr-sg-att' ).val() );
                }
            });
