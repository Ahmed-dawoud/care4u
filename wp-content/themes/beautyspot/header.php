...
<?php endif; ?>
	...
	<!-- HEADER : begin -->
	<header id="header"
		<?php if ( lsvr_get_image_field( 'header_bg_image' ) ) { echo ' style="background-image: url( ' . lsvr_get_image_field( 'header_bg_image' ) . ' );" '; } ?>
			...
			<div class="header-inner">
				...
				<div class="header-branding">
					<a href="<?php echo home_url(); ?>">
						<img src="<?php echo lsvr_get_image_field( 'default_logo' ); ?>"
						<?php if ( lsvr_get_image_field( 'default_logo_2x' ) !== '' ) { echo ' data-hires="' . lsvr_get_image_field( 'default_logo_2x' ) . '"'; } ?>
						width="<?php echo lsvr_get_field( 'default_logo_width', 291 ); ?>"
					...
					<?php global $woocommerce; ?>
						...
						<div class="header-cart">
							<div class="header-cart-inner">
								<a href="<?php echo $cart_url; ?>"><i class="cart-ico fa fa-shopping-cart"></i>
				...
				<!-- HEADER PANEL : begin -->
				<div class="header-panel<?php if ( lsvr_get_field( 'enable_reservation_form_btn', true, true ) ) { echo ' m-has-reservation-btn'; } ?>">
						...
						<ul>
							...
							<li>
								<div class="item-inner">
									<i class="ico fa <?php echo lsvr_get_field( 'header_contact_1_ico' ); ?>"></i>
							...
							<li>
								<div class="item-inner">
									<i class="ico fa <?php echo lsvr_get_field( 'header_contact_2_ico' ); ?>"></i>
							...
							<li>
								<div class="item-inner">
									<i class="ico fa <?php echo lsvr_get_field( 'header_contact_3_ico' ); ?>"></i>
							...
							<li>
								<div class="item-inner">
									<i class="ico fa <?php echo lsvr_get_field( 'header_contact_4_ico' ); ?>"></i>
					...
					<div class="header-social">
						<ul>
							<?php foreach ( $social_links as $key => $val ) : ?>
								<?php if ( strpos( $val, 'http://' ) === 0 || strpos( $val, 'https://' ) === 0 ) : ?>
								<li><a href="<?php echo $val; ?>" class="<?php echo $key; ?>"<?php if ( $social_links_target ) { echo ' target="_blank"'; } ?>><i class="soc-<?php echo $key; ?>"></i></a></li>
								<?php endif; ?>
							<?php endforeach; ?>
						</ul>
					</div>
