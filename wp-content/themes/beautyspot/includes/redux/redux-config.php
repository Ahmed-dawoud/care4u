    ...
    $this->sections[] = array(
        ...
        'fields' => array(
			...
			array(
				'id' => 'twitter_info',
				'type' => 'info',
				'desc' => __( 'You will have to create your own Twitter App in order to use Twitter Feed. Follow <a href="http://iag.me/socialmedia/how-to-create-a-twitter-app-in-8-easy-steps/" target="_blank">this tutorial</a> on how to create it. When you have your Twitter App credentials, enable the feed and fill in all following fields.', 'beautyspot' ),
            ),
